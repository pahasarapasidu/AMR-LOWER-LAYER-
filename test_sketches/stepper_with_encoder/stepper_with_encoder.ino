 ...
 * - Arduino D7 -> ENA+ (Enable)
 * - GND -> PUL-, DIR-, ENA-
 * 
 * RIGHT MOTOR:
 * - Arduino D6 -> PUL+ (Step pulse)
 * - Arduino D5 -> DIR+ (Direction)
 * - Arduino D4 -> ENA+ (Enable)
 * - GND -> PUL-, DIR-, ENA-
 * 
...
// Pin definitions
//Encoders
const int LeftEncoderPin1 = 3;
const int LeftEncoderPin2 = 2;

const int RightEncoderPin1 = 1;
const int RightEncoderPin2 = 0;

volatile long encoderCounterLeft =0;  // Encoder roatation count, this gets reset every time we call update
volatile long lastEncodedLeft;     // Last encoded value
volatile long encoderCounterRight =0;  // Encoder roatation count, this gets reset every time we call update
volatile long lastEncodedRight;

// Left motor pins
const int LEFT_PULSE_PIN = 9;  // Connect to PUL+ of left motor
const int LEFT_DIR_PIN = 8;    // Connect to DIR+ of left motor
const int LEFT_ENA_PIN = 7;    // Connect to ENA+ of left motor

// Right motor pins
const int RIGHT_PULSE_PIN = 6;  // Connect to PUL+ of right motor
const int RIGHT_DIR_PIN = 5;    // Connect to DIR+ of right motor
const int RIGHT_ENA_PIN = 4;    // Connect to ENA+ of right motor
...
void updateLeftEncoder() {
  ...
  Serial.println(encoderCounterLeft);
}
...
void updateRightEncoder() {
  ...
  Serial.println(encoderCounterRight);
}
